package com.grootiyapa.DBCleaner.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Vote> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "vote-group");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);

        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Vote.class.getName());
